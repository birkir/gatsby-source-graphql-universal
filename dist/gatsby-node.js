...
exports.onPreExtractQueries = async ({
  ...
  queryBackend(`{
    ...
    fs.writeFile(`${program.directory}/.cache/fragments/gatsby-source-wagtail-fragments.js`, fragments, err => console.error(err));
  });
};