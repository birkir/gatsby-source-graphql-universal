...
`npm install --save @prismicio/gatsby-source-graphql-universal`
...
By default, `@prismicio/gatsby-source-graphql-universal` will only refetch the data once the server is restarted. It's also possible to configure the plugin to 
